  ...
  return (
    <main className="relative">
      <div className="absolute top-0 right-0 p-3 flex space-x-2">
        <Link
          href="/auth/signin"
          className="font-medium py-1 px-2 sm:py-2 sm:px-4 lg:text-xl text-xs hover:text-[#81c0e9] cursor-pointer"
        >
          Login
        </Link>
      ...
      <div className="flex h-4/6">
        <div className="bg-[#a2dbfa] flex-1 flex items-center justify-center flex-col">
          <div className="my-20 p-3">
            <Image
              ...
              priority={true}
            />
            <h1 className="mt-4 text-center text-white sm:text-xl text-sm">
              あなたのアイデアに、
              <br />
              さらなる可能性を。
            </h1>
        ...
        <div className="flex-1 flex items-center justify-center">
          <h1 className="text-[#a2dbfa] md:text-7xl text-3xl text-center font-ibm border-b-2 border-[#a2dbfa]">
            AIdea Park
          </h1>
        </div>
      </div>
